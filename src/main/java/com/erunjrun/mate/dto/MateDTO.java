...
public class MateDTO {
	...
	public String getExercise_min() {
		return exercise_min;
	}
	public void setExercise_min(String exercise_min) {
		this.exercise_min = exercise_min;
	}
	public String getExercise_dis() {
		return exercise_dis;
	}
	public void setExercise_dis(String exercise_dis) {
