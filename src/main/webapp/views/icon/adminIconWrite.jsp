		...
		<p class="title1" >아이콘 등록</p>
	  	...
	  	<form action="/adminIconWrite" method="post" id="form" enctype="multipart/form-data">
			...
			<div class="input-container">
				...
				<input type="text" name="icon_name" id="text" required/>
			</div>
			<div class="input-container">
				<p class="title2" id="dot">•</p>
				<p class="title2" id="text">가격</p>
				<input type="text" name="cost" id="text" required/>P
			</div>
			...
			<div class="input-container">
				...
				<input type="radio" name="use_yn" value="Y" class="raido" id="radio" checked /><span>활성</span>
				<input type="radio" name="use_yn" value="N" class="raido" id="radio"/><span>비활성</span>
			</div>
