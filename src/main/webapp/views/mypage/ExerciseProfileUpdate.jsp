		...
		<div class="container">
			...
			<form id="profileCreate" action="firstExerciseProfile" method="post"
				...
				<div class="form-group">
					...
					<div style="display: flex; align-items: center;">
						<input type="number" name="exercise_min" id="exercise_min"
							placeholder="분" style="width: 10%; margin-right: 5px;"
				...
				<input type="hidden" name="latitude" id="latitude"
					value="${mypage.latitude}" /> <input type="hidden"
					name="longitude" id="longitude" value="${mypage.longitude}" /> <input
					type="hidden" name="sido" id="sido" value="${mypage.sido}" /> <input
				...
				<div class="form-group">
					...
					<div class="radio-group">
						<label><input type="radio" name="profileVisibility"
							value="Y" ${profileVisibility == 'Y' ? 'checked' : ''}>
							공개</label> <label><input type="radio" name="profileVisibility"
