    ...
    <div class="main-container">
        ...
        <div class="container">
            ...
            <div class="mate-options">
                <p class="title3" onclick="location.href='myMateListView'">(내 운동 메이트)</p>
                <p class="title3 ${pageName == 'myMateListView' ? 'active' : ''}" onclick="location.href='requestedMateListView'">(신청받은 메이트)</p>
                <p class="title3" onclick="location.href='requestingMateListView'">(신청한 메이트)</p>
            </div>
