    ...
    <div class="main-container">
        ...
        <div class="container">
            ...
            <div class="liked-options">
                <p class="title3 ${pageName == 'likedMemberListView' ? 'active' : ''}" onclick="location.href='likedMemberListView'">(관심 멤버)</p>
                <p class="title3" onclick="location.href='blockMemberListView'">(차단 멤버)</p>
            </div>
...
$(document).ready(function() {
    ...
    function loadLikedMemberList(page) {
        $.ajax({
            type: 'GET',
            url: 'likedMemberList.ajax', // 실제 요청할 URL로 변경하세요
                ...
                if (data.error) {
                    ...
                    if (data.list.length === 0) {
                        ...
                        $.each(data.list, function(index, member) {
                            ...
                            console.log("image" + member.profile_image);
                        });
