	...
	<div class="main-container">
		...
		<div class="container">
			...
			<div class="crew-options">
				<p class="title3 ${pageName == 'memberCrewListView' ? 'active' : ''}" onclick="location.href='memberCrewListView'">(소속 크루)</p>
				<p class="title3" onclick="location.href='requestedCrewListView'">(신청 크루)</p>
