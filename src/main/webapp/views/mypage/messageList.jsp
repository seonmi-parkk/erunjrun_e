	...
	<div class="main-container">
		...
		<div class="container">
			...
			<div class="chat-options">
				<p class="title3 ${pageName == 'messageListView' ? 'active' : ''}" onclick="location.href='messageListView'">(1:1 대화방)</p>
				<p class="title3" onclick="location.href='crewMasterMessageListView'">(그룹장과의 대화방)</p>
				</div>
				<div class="chat-list">
					<!-- 리스트가 여기에 동적으로 추가됩니다. -->
				</div>
...
$(document).ready(function() {
    ...
    function loadChatList(page) {
        $.ajax({
            type: 'GET',
            url: 'messageList.ajax', // 실제 요청할 URL로 변경하세요
