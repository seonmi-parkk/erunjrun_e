	    ...
	    <div class="bubu">
	    	<div class="bbs">
	    		<c:if test="${sessionScope.loginId == info.id || sessionScope.adminYn == 'Y'}">
			        <button type="button" class="btn01-l" onclick="location.href='/askBoardUpdate/${info.ask_idx}'">수정</button>
...
<script>
		...
		function commentDraw(list) {
			...
			list.forEach(function(view,idx){
				...
				content +='<div>';
				content +='<div class="nick"><img style="height: 30;" src="/resources/img/run/running_8421565.png" alt="아이콘">'+addName+'</div>';
				if(view.use_yn == 'N'){
