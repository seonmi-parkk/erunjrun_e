...
<head>
    ...
    <script src="/resources/js/askSummerNote.js"></script>
    ...
    $('input[name="tag_idx_list"]').on('change', function () {
        ...
        /* 레이어팝업 */
	 	function secondBtn1Act() {
            ...
            console.log("코드 : ",code_name);
          

            formData.append('content', content);
            formData.append('id', userId);
			formData.append('ask_idx',"${post.ask_idx}");
            ...
            $.ajax({
                ...
                success: function (data) {
                    console.log(data);
                    location.href = "/askBoardDetail/" + "${post.ask_idx}";
                },
